...
fn glider() {
    let mut life =
        smeagol::Life::from_rle(&smeagol_rle::Rle::from_file("./assets/glider.rle").unwrap());
...
fn sir_robin() {
    let mut life =
        smeagol::Life::from_rle(&smeagol_rle::Rle::from_file("./assets/sirrobin.rle").unwrap());
...
fn weekender() {
    let mut life =
        smeagol::Life::from_rle(&smeagol_rle::Rle::from_file("./assets/weekender.rle").unwrap());
